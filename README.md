...
> 🇩🇪 Eine deutsche Fassung dieser README liegt in [README.de.md](README.de.md).

**Agentless management for your entire Linux fleet - one binary, any number of servers.**
