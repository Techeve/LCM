...
| Background goroutines (job runners, workers, listeners) | [`internal/safego`](https://gitlab.techeve.de/techeve/lcm/-/tree/community/internal/safego?mtm_campaign=linking&mtm_kwd=doc) - `safego.Go` / `safego.GoCleanup` |
