...
| Background goroutines (job runners, workers, listeners) | [`internal/safego`](https://gitlab.techeve.de/techeve/lcm/-/tree/main/internal/safego) - `safego.Go` / `safego.GoCleanup` |
