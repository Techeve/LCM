...
| Hintergrund-Goroutinen (Job-Runner, Worker, Listener) | [`internal/safego`](https://gitlab.techeve.de/techeve/lcm/-/tree/community/internal/safego?mtm_campaign=linking&mtm_kwd=doc) - `safego.Go` / `safego.GoCleanup` |
