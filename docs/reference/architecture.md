...
| Hintergrund-Goroutinen (Job-Runner, Worker, Listener) | [`internal/safego`](https://gitlab.techeve.de/techeve/lcm/-/tree/main/internal/safego) - `safego.Go` / `safego.GoCleanup` |
